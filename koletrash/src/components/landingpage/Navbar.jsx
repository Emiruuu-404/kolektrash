    ...
    <nav className="fixed w-full z-50 bg-green-700">
      <div className="max-w-[1240px] mx-auto px-8 py-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link 
            to="/login" 
            className="ml-8 px-6 py-2 bg-white hover:bg-gray-100 text-green-700 font-medium rounded-md shadow-sm transition-colors duration-200"
          >
            Login
          </Link>
        </div>
      ...
      {open && (
        <div className="md:hidden absolute top-full left-0 right-0 px-8 py-4 space-y-4 bg-white shadow-lg">
          ...
          <Link 
            to="/login" 
            className="w-full bg-green-700 hover:bg-green-600 text-white px-4 py-2 rounded-md font-medium shadow-sm transition-colors duration-200 block text-center"
          >
            Login
          </Link>
        </div>
