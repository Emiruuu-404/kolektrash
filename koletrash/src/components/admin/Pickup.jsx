...
const BARANGAYS = [
  'All', 'Sagrada Familia', 'Aldezar', 'Bulan', 'Biglaan', 'Salvacion', 'North Centro', 'South Centro', 'Priority Area'
];
...
const MOCK_REQUESTS = [
  {
    ...
    address: 'Blk 5 Lot 12, Sagrada Familia',
    barangay: 'Sagrada Familia',
    wasteType: 'Yard Waste',
    submitted: '2025-05-10',
    preferred: '2025-05-12',
    status: 'Pending',
    image: '',
    remarks: '',
    details: 'Tree branches and leaves from backyard cleanup.'
  },
  {
    id: 'REQ-002',
    resident: 'Maria Santos',
    address: 'Zone 2, Salvacion',
    barangay: 'Salvacion',
    wasteType: 'Appliance',
    submitted: '2025-05-09',
    preferred: '2025-05-13',
    status: 'Scheduled',
    image: '',
    remarks: '',
    details: 'Old refrigerator for disposal.'
  },
  {
    id: 'REQ-003',
    resident: 'Pedro Cruz',
    address: 'Purok 3, Bulan',
    barangay: 'Bulan',
    wasteType: 'Hazardous',
    submitted: '2025-05-08',
    preferred: '2025-05-14',
    status: 'Declined',
    image: '',
    remarks: 'Not eligible for hazardous waste pick-up.',
    details: 'Paint cans and chemicals.'
  },
  {
    id: 'REQ-004',
    resident: 'Ana Villanueva',
    address: 'Sitio Malinis, Biglaan',
    barangay: 'Biglaan',
    wasteType: 'Bulk',
    submitted: '2025-05-07',
    preferred: '2025-05-15',
    status: 'Completed',
    image: '',
    remarks: '',
    details: 'Old furniture and mattresses.'
  }
];
