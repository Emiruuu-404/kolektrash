    ...
    <div className="min-h-screen flex flex-col bg-gray-50 w-full max-w-full relative">
      ...
      {showFeedback && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/20 backdrop-blur-sm z-50">
          <form className="bg-white rounded-xl shadow-lg p-8 max-w-sm w-full flex flex-col items-center" onSubmit={e => { e.preventDefault(); setShowFeedback(false); setFeedback(''); alert('Thank you for your feedback!'); }}>
            ...
            <textarea
              className="w-full border border-gray-200 rounded-lg p-3 mb-4 focus:outline-green-700 focus:ring-2 focus:ring-green-100"
              rows={4}
            ...
            <div className="flex gap-4 w-full">
              <button
                type="submit"
                className="flex-1 py-2.5 rounded-lg bg-green-700 text-white font-semibold hover:bg-green-800 transition focus:outline-green-700 focus:ring-2 focus:ring-green-100"
              >
                Submit
              </button>
              <button
                type="button"
                className="flex-1 py-2.5 rounded-lg border border-gray-200 bg-white text-green-700 font-semibold hover:bg-green-50 transition focus:outline-green-700 focus:ring-2 focus:ring-green-100"
                onClick={() => setShowFeedback(false)}
              >
                Cancel
              </button>
