...
const weeklySchedules = {
  ...
  Tuesday: [
    { time: '6:00', barangay: 'NORTH CENTRO', color: 'bg-green-100' },
    { time: '7:00', barangay: 'IMPIG', color: 'bg-yellow-100' },
    { time: '9:00', barangay: 'SOUTH CENTRO', color: 'bg-blue-100' },
    { time: '11:00', barangay: 'TARA', color: 'bg-red-100' },
  ],
  Wednesday: [
    { time: '6:30', barangay: 'SOUTH CENTRO', color: 'bg-blue-100' },
    { time: '8:00', barangay: 'IMPIG', color: 'bg-yellow-100' },
    { time: '10:00', barangay: 'NORTH CENTRO', color: 'bg-green-100' },
    { time: '14:00', barangay: 'TARA', color: 'bg-red-100' },
  ],
  Thursday: [
    { time: '6:00', barangay: 'TARA', color: 'bg-red-100' },
    { time: '8:30', barangay: 'NORTH CENTRO', color: 'bg-green-100' },
    { time: '10:30', barangay: 'IMPIG', color: 'bg-yellow-100' },
    { time: '13:00', barangay: 'SOUTH CENTRO', color: 'bg-blue-100' },
  ],
  Friday: [
    { time: '6:00', barangay: 'IMPIG', color: 'bg-yellow-100' },
    { time: '7:30', barangay: 'TARA', color: 'bg-red-100' },
    { time: '9:30', barangay: 'NORTH CENTRO', color: 'bg-green-100' },
    { time: '11:30', barangay: 'SOUTH CENTRO', color: 'bg-blue-100' },
  ],
};
