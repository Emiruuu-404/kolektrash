...
export default function ResidentIEC() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Information & Education Center</h1>
          <p className="text-gray-600">Access educational materials about proper waste management and environmental care.</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-xl p-6 mb-8 text-white">
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="flex-1">
              ...
              <p className="mb-4 text-green-100">Learn the basics of proper waste segregation and help create a cleaner environment.</p>
